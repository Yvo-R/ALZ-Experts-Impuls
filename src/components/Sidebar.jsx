        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '10px' }}>
                    <Reorder.Group axis="y" values={frames} onReorder={onReorder} style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                        {frames.map((frame, index) => (
                            <Reorder.Item key={frame.id} value={frame} style={{ position: 'relative' }}>
                                <div style={{
                                    marginBottom: '15px',
                                    padding: '10px',
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '5px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            {/* Drag Handle */}
                                            <div style={{ cursor: 'grab', color: 'rgba(255,255,255,0.3)', fontSize: '1.2rem', lineHeight: 1 }}>
                                                ⋮⋮
                                            </div>
                                            <div
